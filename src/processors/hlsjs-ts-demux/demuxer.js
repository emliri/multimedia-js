    ...
    if (config.enableWorker && (typeof (Worker) !== 'undefined')) {
      ...
      try {
        ...
        w.onerror = function (event) {
          hls.trigger(Event.ERROR, { type: ErrorType.OTHER_ERROR, details: ErrorDetail.INTERNAL_EXCEPTION, fatal: true, event: 'demuxerWorker', err: { message: event.message + ' (' + event.filename + ':' + event.lineno + ')' } });
        };
