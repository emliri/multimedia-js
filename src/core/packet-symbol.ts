...
export enum PacketSymbol {
  ...
  RESUME = 3, // further data received should be processed now and pipelined (made ready for transfer)
  ...
  LATENCY_PROBE = 10 // used as a latency probe packet (measure diff on transfer to creation timestamp)
}
